...
@Repository
public interface EngineeringConservationDao extends JpaRepository<EngineeringConservation, Integer>{
	...
	@Query(value = "SELECT tt.id,tt.nm,t1.nm oneLevel,t1.name oneLevelName,t2.nm twoLevel,t2.name twoLevelName,   " + 
			...
			"FROM t_engineering_conservation as tt  " + 
			...
			countQuery = "SELECT COUNT(1)" + 
					...
					"from t_engineering_conservation t0  " + 
	...
	Page<EngineeringConservationVO> page(@Param("projectName")String projectName,Pageable pageable);
