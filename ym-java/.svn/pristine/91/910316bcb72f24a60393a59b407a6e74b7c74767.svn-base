...
@ApiModel("实物指标汇总--分项")
public class AbmAggregateTreeVO {
	...
	@ApiModelProperty("子集")
	private List<AbmAggregateTreeVO> children;
	...
	public List<AbmAggregateTreeVO> getChildren() {
		return children;
	}

	public void setChildren(List<AbmAggregateTreeVO> children) {
