...
import com.lyht.business.info.service.InfoHomesteadService;
...
@Api(value = "/info/homestead", tags = "宅基地相关api")
@RestController
@RequestMapping("/info/homestead")
public class InfoHomesteadController {

	@Autowired
	private InfoHomesteadService infoHomesteadService;
	...
	@PostMapping("/page")
	public LyhtResultBody<List<InfoHomesteadVO>> save(LyhtPageVO lyhtPageVO, String region, String ownerName,
			String scope, String projectFcode, String isDirtyData, String ownerNm) {
		LyhtResultBody<List<InfoHomesteadVO>> page = infoHomesteadService.page(region, ownerName, scope, projectFcode,
	...
	@PostMapping("/save")
	public LyhtResultBody<InfoHomesteadEntity> save(InfoHomesteadEntity infoHomesteadEntity) {
		InfoHomesteadEntity save = infoHomesteadService.save(infoHomesteadEntity);
	...
	public LyhtResultBody<Integer> save(Integer id) {
		LyhtResultBody<Integer> delete = infoHomesteadService.delete(id);
		return delete;
	}
