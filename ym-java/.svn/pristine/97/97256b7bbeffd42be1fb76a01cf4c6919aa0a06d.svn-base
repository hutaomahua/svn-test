...
public class AesUtil{
    ...
    public static final String AES_KEY = "^MSDI*SMART+TOP$";
    ...
    public static String aesEncrypt(String content, String encryptKey) {
        try{
            ...
            throw new LyhtRuntimeException("加密失败,原因:" + e.getMessage());
        }
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        String jsData = aesDecrypt("EWpIPzagdGUL/RMMFRU8PA==", AES_KEY);
