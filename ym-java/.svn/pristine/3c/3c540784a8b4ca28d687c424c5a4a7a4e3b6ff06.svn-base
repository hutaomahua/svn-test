...
@Repository
public interface EngineeringImplementationInfoDao extends JpaRepository<EngineeringImplementationInfo, Integer> {

	@Query(value = "SELECT tt.id,tt.nm,t1.nm oneLevel,t1.name oneLevelName,t2.nm twoLevel,t2.name twoLevelName,  " + 
			"t3.nm threeLevel,t3.name threeLevelName,t4.nm projectNm,t4.name projectName, t8.nm majorType,t8.name majorTypeName, " + 
			...
			"if(tt.is_replace=1,'是','否') isReplace,tt.replace_unit replaceUnit,tt.design_unit designUnit, t9.nm areaNm,t9.name areaName, " + 
			...
			"FROM t_engineering_implementation_info as tt " + 
			...
			"left join pub_dict_value t8 on tt.major_type = t8.nm " + 
			"LEFT JOIN pub_dict_value t9 on tt.area_nm = t9.nm " + 
			...
			countQuery = "SELECT COUNT(1)" + 
					...
					"from t_engineering_implementation_info t0 " + 
	...
	public Page<EngineeringImplementationInfoVO> page(@Param("projectName")String projectName,Pageable pageable);
