...
@ApiModel(description = "零星树木表")
@EntityListeners(AuditingEntityListener.class)
@Entity
@Table(name = "t_info_trees")
public class InfoTreesEntity {
	...
	public Integer getBreastHeight() {
		return breastHeight;
	}

	public void setBreastHeight(Integer breastHeight) {
