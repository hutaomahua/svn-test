...
//
//@Api(value = "/owner/excel/data", tags = "权属人excel数据处理相关api")
//@RestController
//@RequestMapping("/owner/excel/data")
//public class OwnerExcelDataController {
//
//	@Autowired
...
//	@GetMapping("/zhibiao")
//	public void zhibiao() {
//		List<Map<String, Object>> all = jdbcTemplate.queryForList("SELECT * FROM t_test_owner_data;");
//		int count = 0;
